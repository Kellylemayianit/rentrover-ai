 ...
 * @param {{checkIn?:string, checkOut?:string, guests?:number, platform?:string}} dates
 */
export function buildBookingMessage(items, { checkIn = '', checkOut = '', guests = '', platform = '' } = {}) {
  if (!items.length) return '';

  const header = '🧭 *RentRover AI — Booking Request*\n━━━━━━━━━━━━━━━━━━━━━━━━\n\n';

  const detailBlock = (checkIn || checkOut || guests || platform)
    ? '📅 *Trip details*\n' +
