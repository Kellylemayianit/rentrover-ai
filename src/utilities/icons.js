...
export const ICONS = {
  ...
  sun: `<svg width="17" height="17" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="3.5" stroke="currentColor" stroke-width="1.5"/><path d="M9 1.5v2M9 14.5v2M16.5 9h-2M3.5 9h-2M14.3 3.7l-1.4 1.4M5.1 12.9l-1.4 1.4M14.3 14.3l-1.4-1.4M5.1 5.1L3.7 3.7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,

  moon: `<svg width="17" height="17" viewBox="0 0 18 18" fill="none"><path d="M15.5 10.4A6.5 6.5 0 017.6 2.5a6.5 6.5 0 107.9 7.9z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>`,

  user: `<svg width="17" height="17" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="6.2" r="3" stroke="currentColor" stroke-width="1.5"/><path d="M2.8 15c.6-3 3-5 6.2-5s5.6 2 6.2 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
};
